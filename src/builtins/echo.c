...
/* checks if there are any -n / -nnnnn arguments and returns the number of -n /
	-nnnnn arguments found */
...
/* prints out the given arguments to the terminal, jumps over the -n /
	-nnnnn flags */
